...
int main () {
    ...
    Forme * p ; // Pointeur sur objet de type Forme 
    p = new Rectangle(2,2,4,3,0) ; 
    p->Affiche() ; // Coder le comportement en polymorphisme de affiche == Faire de l'abstraction , mot clé : virtual 
